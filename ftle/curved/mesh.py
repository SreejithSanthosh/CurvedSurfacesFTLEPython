...
def FTLE_mesh(
    ...
    if direction == "backward":
        ...
        initial_time = final_idx
        final_time = initial_idx
    else:
        if initial_time > final_time:
    ...
    if plot_ftle:
        plot_FTLE_mesh(node_connections[old_it], node_positions[old_it], old_it, old_ft, ftle, direction, save_path, camera_setup)
