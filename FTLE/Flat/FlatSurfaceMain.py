...
def run_FTLE_2d(
    ...
    if plot_ftle:
        ...
        plot_FTLE_2d(particles_positions, ftle, isotropy, back_ftle, back_isotropy, initial_time, final_time, save_plot_path)
...
def run_FTLE_3d(
    ...
    if plot_ftle:
        ...
        plot_FTLE_3d(particles_positions, ftle, isotropy, back_ftle, back_isotropy, initial_time, final_time, save_plot_path)
